...
<body>
    <header>
        <nav>
            <div class="row">
                ...
                <a class="mobile-nav-icon js--nav-icon">
                    <ion-icon name="close" class="hide"></ion-icon>
                </a>
            </div>
        </nav>
    ...
    <section class="section-features js--section-features" id="features">
        ...
        <div class="row js--wp-1">
            <div class="col span-1-of-4 box">
                <ion-icon name="ios-infinite" class="icon-feature"></ion-icon>
            ...
            <div class="col span-1-of-4 box">
                <ion-icon name="ios-time" class="icon-feature"></ion-icon>
            ...
            <div class="col span-1-of-4 box">
                <ion-icon name="ios-nutrition" class="icon-feature"></ion-icon>
                <h3>100% organic</h3>
                <p>
            ...
            <div class="col span-1-of-4 box">
                <ion-icon name="ios-cart" class="icon-feature"></ion-icon>
    ...
    <section class="section-meals">
        ...
        <ul class="meals-showcase clearfix">
            ...
            <li>
                <figure class="meal-photo">
                    <img src="resources/img/6.jpg" alt="Burger with cheddar and bacon">
                </figure>
            </li>
            <li>
                <figure class="meal-photo">
    ...
    <section class="section-steps" id="works">
        ...
        <div class="row">
            <div class="col span-1-of-2 steps-box">
                <img src="resources/img/app-iPhone.png" alt="omnifood app on iphone" class="app-screen js--wp-3">
            </div>
            <div class="col span-1-of-2 steps-box">
                ...
                <a href="#" class="btn-app">
                    ...
                    <img src="resources/img/download-app-android.png" alt="Google store button">
                </a>
            </div>
        </div>
    </section>
        ...
        <div class="row js--wp-2">
            <div class="col span-1-of-4 box">
                ...
                <div class="city-feature">
                    <ion-icon name="ios-person" class="icon-small"></ion-icon>
                    1600+ happy eaters
                </div>
                <div class="city-feature">
                    <ion-icon name="ios-star" class="icon-small"></ion-icon>
                    60+ top chefs
                </div>
                <div class="city-feature">
                ...
                <div class="plain-box">
                    ...
                    <div class="">
                        <ul>
                            ...
                            <li>
                                <ion-icon name="close-circle-outline" class="icon-small"></ion-icon>
                            </li>
                            <li>
                                <ion-icon name="checkmark" class="icon-small"></ion-icon>Free delivery
                            </li>
            ...
            <div class="row" id="form">
                ...
                <form method="post" action="mailer-new.php" class="contact-form">
                    ...
                    <div class="row">
                        ...
                        <div class="col span-2-of-3">
                            <textarea name="message" id="message" cols="20" rows="3"
        ...
        <div class="row">
            ...
            <div class="col span-1-of-2">
                <ul class="social-links">
                    <li><a href="">
                            <ion-icon name="logo-facebook" class="f"></ion-icon>
                        </a></li>
                    <li><a href="">
                            <ion-icon name="logo-twitter" class="t"></ion-icon>
                        </a></li>
                    <li><a href="">
                            <ion-icon name="logo-googleplus" class="g"></ion-icon>
                        </a></li>
                    <li><a href="">
                            <ion-icon name="logo-instagram" class="i"></ion-icon>
                        </a></li>
                </ul>
            </div>
        </div>
